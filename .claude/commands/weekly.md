...
- User's YouTube refs: @RhinoFinance (犀牛财经), @财经观察站

## Steps

### Phase 1: Read ALL State Files (保留原有)
...
### Phase 3: Generate Reports & Fetch Data (保留原有)
...
### Phase 4: Discrepancy Check (保留原有)
...
### Phase 4b: Market Top Detection & Theme Lifecycle (新增 from exposure-coach + stock-discovery)
20b. Run the 6-component Market Top Detection scoring (from exposure-coach skill):
    - Distribution day count, leading stock health, defensive rotation, breadth divergence, index technicals, sentiment
...
### Phase 5: Position Build Review (保留原有 + 强化)
...
### Phase 7: Deep Market Analysis & Independent Reasoning (新增核心)
...
### Phase 8: Next Week Outlook — 前瞻性分析 (新增核心)
